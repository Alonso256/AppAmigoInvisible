...
public class CorreoElectronico {
	...
	public void enviarConGMail() {
		...
		// remitente también.
		String remitente = new DataEmail().getRemitente(); // Para la dirección nomcuenta@gmail.com

		Properties props = System.getProperties();
		props.put("mail.smtp.host", "smtp.gmail.com"); // El servidor SMTP de Google
		props.put("mail.smtp.user", remitente);
		props.put("mail.smtp.clave", new DataEmail().getClave()); // La clave de la cuenta
		...
		try {
			...
			transport.connect("smtp.gmail.com", remitente, new DataEmail().getClave());
